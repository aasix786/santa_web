...
<div class="main-boody termsPolicy">
    ...
    <div class="container" style="padding-top: 40px">
                        ...
                        located at WeCaughtSanta.com.</p>
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                        use We Caught Santa if you do not agree to take all of the terms and conditions stated on this page.</p>
                        ...
                        and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves.</p>
                        ...
                        <h2>Cookies</h2>
                        <p>We employ the use of cookies. By accessing We Caught Santa, you agreed to use cookies in
                            agreement with the B3 Events INC's Privacy Policy.</p>
                        ...
                        <h2>License</h2>
                        <p>Unless otherwise stated, B3 Events INC and/or its licensors own the intellectual property rights for all
                            material on We Caught Santa. All intellectual property rights are reserved. You may access this from
                            We Caught Santa for your own personal use subjected to restrictions set in these terms and
                            conditions.</p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from We Caught Santa </li>
                            <li>Sell, rent or sub-license material from We Caught Santa</li>
                            <li>Reproduce, duplicate or copy material from We Caught Santa</li>
                            <li> Redistribute content from We Caught Santa</li>
                        </ul>
                        <!-- ------ -->
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                            certain areas of the website. B3 Events INC does not filter, edit, publish or review Comments prior to
                            their presence on the website. Comments do not reflect the views and opinions of B3 Events INC,its
                            agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                            and opinions. To the extent permitted by applicable laws, B3 Events INC shall not be liable for the
                            ...
                            <p>B3 Events INC reserves the right to monitor all Comments and to remove any Comments which can
                        ...
                        <p>You hereby grant B3 Events INC a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
...
shopping malls, and charity fundraising groups which may not hyperlink to our Web site.</li>
                        ...
                        <p>commonly-known consumer and/or business information sources;
                            ...
                            absence of B3 Events INC; and (d) the link is in the context of general resource information.
                        </p>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                            website, you must inform us by sending an e-mail to B3 Events INC. Please include your name, your
                            ...
                            <ul>
                                ...
                                <li>By use of any other description of our Website being linked to that makes sense within the</li>
                            </ul>
                        <p>context and format of content on the linking party’s site.
                            No use of B3 Events INC's logo or other artwork will be allowed for linking absent a trademark
                            license agreement.</p>
                            <h2>iFrames</h2>
